...
mkdir(strcat(oldPath, 'FullAnalysis\'));
...
for i = 1:length(h_range)
    ...
    New_State_Out{i, 2} = SS_Array{i, 2};
end
...
filenamey = strcat(saveDir, erase(filename,'_newAnalysis.mat'), '_timeDiff.mat');
save(filenamey, 'New_State_Out', 'New_Cond_Array')
